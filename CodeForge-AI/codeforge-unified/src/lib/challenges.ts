import { assessmentTasks } from '@/data/assessment-tasks';
import { assessmentSolutions } from '@/data/assessment-solutions';
import { assessmentChallenges } from './assessments';
import { CHALLENGES } from '@/data/adaptive-challenges';
import { diagnosticTasks } from '@/data/diagnostics';
import { TestCategory, type TestCase } from '@/engines/challenges/domain/types';
import { adaptiveChallenges } from './adaptive';
import { SEED_CHALLENGES } from '@/engines/challenges/data/seedChallenges';
import { SupportedLanguage } from '@/engines/challenges/domain/types';
