...
.pv-tab:hover { color: var(--ink); background: rgba(255,255,255,0.04); }
...
.pv-kpicell.is-warn { background: rgba(244, 63, 94, 0.15); }
...
.pv-delta-track { height: 6px; background: rgba(255,255,255,0.08); border-radius: 3px; overflow: hidden; }
...
.pv-delta-chip { display: inline-flex; align-items: center; gap: 3px; background: rgba(244, 63, 94, 0.15); color: var(--risk); padding: 2px 7px; border-radius: 20px; font-family: 'IBM Plex Mono', monospace; font-size: 11px; font-weight: 600; }
...
.pv-funnel-track { height: 8px; background: rgba(255,255,255,0.06); border-radius: 2px; overflow: hidden; }
...
.pv-callout { display: flex; gap: 10px; background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.25); border-radius: 8px; padding: 12px 14px; margin-top: 16px; color: var(--ink); }
...
.pv-table-header { background: rgba(255,255,255,0.05); font-size: 10.5px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--ink-soft); }
...
.pv-table-row:hover { background: rgba(255,255,255,0.03); }
...
.pv-table-detail { display: grid; grid-template-columns: repeat(3, 1fr); gap: 14px; padding: 14px 18px 18px; background: rgba(255,255,255,0.025); }
...
.pv-factor-track { height: 6px; background: rgba(255,255,255,0.08); border-radius: 3px; overflow: hidden; }
...
.pv-severity-critical { background: rgba(244, 63, 94, 0.15); color: var(--risk); }
.pv-severity-warning { background: rgba(245, 158, 11, 0.15); color: var(--brass-deep); }
.pv-severity-info { background: rgba(255,255,255,0.07); color: var(--ink-soft); }

/* Evidence modal */
.pv-modal-backdrop { position: fixed; inset: 0; background: rgba(0,0,0,0.6); display: flex; align-items: center; justify-content: center; z-index: 50; padding: 20px; }
